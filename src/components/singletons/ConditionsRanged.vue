  ...
  >
    <template slot="content">
      <p>
        ...
        is converted to Chain Expertise ({{parseExpertise(expertise.gunKnowledge.value * 0.4)}})
      </p>
      <p>
...
export default {
  ...
  computed: {
    ...
    classRank() {
      ...
      var a = Number.parseInt(Math.min((gunKnowledge + crushingTechnique + demonology),8800)) / 100;
      var b = a.toString();
      if (a === 0) {
        return "Class 0 Rank 0";
      } else if (a >= 100) {
