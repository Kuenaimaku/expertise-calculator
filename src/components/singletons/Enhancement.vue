<template>
  ...
  >
    <template slot="content">
      <p>
        <span class="option-title">Curative Magic</span>: minimum Class 2 Rank 0.
        <span class="option-title">30%</span>
        is converted to Chain Expertise ({{parseExpertise(expertise.curativeMagic.value * 0.3)}})
      </p>
      <p>
      ...
      <p>
        ...
        <span class="option-title">30%</span>
        is converted to Chain Expertise ({{parseExpertise(expertise.bless.value * 0.3)}})
      </p>
    </template>
  </chain-expertise>
</template>
...
export default {
  ...
  computed: {
    ...
    classRank() {
      ...
      var a =
        Number.parseInt(curativeMagic + supportMagic + bless) /
        100;
      var b = a.toString();
      if (a === 0) {
        return "Class 0 Rank 0";
